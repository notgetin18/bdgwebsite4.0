        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="pl-8">
            <p className="mb-6">
              ...
              now. Bright Gold is an organisation to refine and recycle precious
              metals such as gold and silver. As a refiner and manufacturer,
              they are traders, suppliers, and service providers as well.
            </p>
            ...
            <p className="mb-6">
              ...
              digital gold. We endeavour to make your digital gold savings such
              as buying, selling, delivery of digital gold and silver in the
              simplest possible way.
            </p>
            <p>
              Everyone will always expect pure and quality Gold for their
              savings, Bright DiGi Gold will ensure purity and high-quality gold
              in physical form. We offer 24 karat 99.9% pure gold and 99.99%
              fine silver with a certificate of purity. You can begin to save on
              our platform with as little as ₹10. Not just that your digital
              gold is secured in the world class vault.
            </p>
          </div>
          <div>
